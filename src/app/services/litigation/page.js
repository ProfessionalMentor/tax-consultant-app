...
export default function LitigationPage() {
  const practices = [
    { title: "Civil Litigation", icon: <Scale className="w-8 h-8 text-gold" />, desc: "Property disputes, breach of contract, and multi-million rupee recovery suits across the High Courts of Pakistan." },
    { title: "Criminal Defense", icon: <ShieldAlert className="w-8 h-8 text-gold" />, desc: "White-collar defense, FIA cybercrime acquittals, and appellate representation by Advocate Khalil ur Rehman Butt." },
    { title: "Corporate Banking Suits", icon: <Gavel className="w-8 h-8 text-gold" />, desc: "Defending corporate entities against financial banking tribunals and hostile liquidation maneuvers." },
    { title: "Intellectual Property", icon: <FileCheck className="w-8 h-8 text-gold" />, desc: "Trademark infringements, copyright enforcement, and SaaS code theft litigation." }
  ];
    ...
    <div className="pt-32 pb-24 bg-midnight min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-slate-950 border border-slate-800 p-12 rounded-3xl text-center shadow-2xl relative overflow-hidden">
          ...
          <h2 className="text-3xl font-bold text-white mb-6 relative z-10">Facing Complex Chambers or the FIA?</h2>
          <p className="text-slate-400 mb-8 max-w-2xl mx-auto relative z-10">
            Law is unforgiving to those who delay. Secure an immediate confidential consultation with Advocate Ahmad Raza or Advocate Khalil ur Rehman Butt.
          </p>
          <a href="/dashboard/appointments" className="inline-block px-10 py-5 bg-gold hover:bg-yellow-600 text-midnight font-black tracking-wide rounded-xl transition-all shadow-lg shadow-gold/20 transform hover:-translate-y-1 relative z-10">
